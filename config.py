...
SQLALCHEMY_DATABASE_URI = 'mysql://zhenjianlee:zhenjianLEE24!@localhost:3306/flaskAPPBuilder1'
...
OAUTH_PROVIDERS=[
     {
        ...
        "remote_app": {
            "client_id": "flaskAPPBuilder1",
            "client_secret": "z9YdAQ6n7SUA6sRXvgNWoPZj3AuJnZ3l",
